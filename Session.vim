...
silent only
cd ~/mooc/freecodecamp/projets/calculator
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +153 ~/mooc/freecodecamp/projets/calculator/index.html
badd +1 ~/mooc/freecodecamp/projets/calculator/css/style.css
badd +64 ~/mooc/freecodecamp/projets/calculator/js/calc.js
badd +3 ~/mooc/freecodecamp/projets/calculator/js/clock.js
argglobal
silent! argdel *
argadd index.html
set stal=2
edit ~/mooc/freecodecamp/projets/calculator/index.html
...
wincmd w
argglobal
edit ~/mooc/freecodecamp/projets/calculator/css/style.css
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-Tab> <Plug>delimitMateS-Tab
imap <buffer> <S-BS> <Plug>delimitMateS-BS
...
exe 'vert 1resize ' . ((&columns * 99 + 85) / 170)
exe 'vert 2resize ' . ((&columns * 70 + 85) / 170)
tabedit ~/mooc/freecodecamp/projets/calculator/js/calc.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 62 - ((12 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
...
wincmd w
argglobal
edit ~/mooc/freecodecamp/projets/calculator/js/clock.js
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-Tab> <Plug>delimitMateS-Tab
imap <buffer> <S-BS> <Plug>delimitMateS-BS
